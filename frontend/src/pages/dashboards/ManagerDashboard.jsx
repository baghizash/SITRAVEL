    ...
    >
      {loading ? (
        ...
        <>
          ...
          <div className="mt-10 rounded-2xl bg-white border border-[#e0e0e0] p-6">
            <div className="text-[10px] tracking-[0.3em] uppercase text-[#8b0000]">Pendapatan per rute</div>
            <h2 className="font-display text-2xl font-bold text-[#141414] tracking-tight mt-1">Top rute travel Anda</h2>
          ...
          <div className="mt-8 rounded-2xl bg-white border border-[#e0e0e0] overflow-hidden">
            <div className="p-5 border-b border-[#e0e0e0]">
              <h3 className="font-display text-xl font-bold text-[#141414]">Pemesanan Terbaru</h3>
            </div>
            <div className="grid grid-cols-[110px_1fr_1fr_1fr_120px] px-5 py-3 border-b border-[#e0e0e0] text-[10px] tracking-[0.25em] uppercase text-[#4b4b4b] bg-[#f2f2f2]">
              <div>Kode</div><div>Penumpang</div><div>Rute</div><div>Berangkat</div><div>Total</div>
            </div>
            {bookings.slice(0, 10).map((b) => (
              <div key={b.id} className="grid grid-cols-[110px_1fr_1fr_1fr_120px] px-5 py-3 border-b border-[#e0e0e0] items-center text-sm">
